...
[[ ! -f ~/.zshrc.original ]] && cp ~/.zshrc ~/.zshrc.original #|| printf "\n'%s/.zshrc.original' already exists\n" "$HOME"
...
[[ ! -f ~/.p10k.zsh.original ]] && cp ~/.p10k.zsh ~/.p10k.zsh.original #|| printf "\n'%s/.p10k.zsh.original' already exists\n" "$HOME"
